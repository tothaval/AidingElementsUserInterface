 ...
 *      OptionsElement_ContainerData element 
 * 
 * basic options element to configure ContainerData properties
 *
 * 
 * init:        2024|01|11
 * DEV:         Stephan Kammel
...
{
    internal class OptionsElement_ContainerData : CoreContainer
    {        // set position values for all selected containers
        // --> x, y, z coordinates on the canvas

        // build in an option to apply changes to selected containers only.
