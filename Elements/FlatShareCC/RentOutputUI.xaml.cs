...
namespace AidingElementsUserInterface.Elements.FlatShareCC
{
    ...
    public partial class RentOutputUI : UserControl
    {
        ...
        private void _room_name()
        {
            if (fd != null)
            {
                LL_room_name.Content = $"{fd.rooms[rnr - 1].name} - {fd.rooms[rnr - 1].area}{Units.area}";
            }
        ...
        {
            FlatShareCC_Calculations calculate = new FlatShareCC_Calculations(fd, fc);
        ...
        internal void setup_rent_output()
        {
            ...
            DIE_cold_rent_room.configurate("room", true, Units.currency);
            DIE_cold_rent_share.configurate("share", true, Units.currency);
            DIE_cold_rent.configurate(">", true, Units.currency);
            ...
            DIE_extra_costs_advance.configurate("+", true, Units.currency);

            DIE_monthly_costs.configurate("=", true, Units.currency);
